...
use PizzaChen\Umeng\Android\AndroidBroadcast;
use PizzaChen\Umeng\Android\AndroidCustomizedcast;
use PizzaChen\Umeng\Android\AndroidFilecast;
use PizzaChen\Umeng\Android\AndroidGroupcast;
use PizzaChen\Umeng\Android\AndroidListcast;
use PizzaChen\Umeng\Android\AndroidUnicast;
use Log;
...
class AndroidPusher extends Pusher
{
     ...
     * @return mixed
     * @throws \PizzaChen\Umeng\Exception\UmengException
     */
    ...
    public function sendUnicast($device_tokens = '', $predefined= [], $extraField = []) {
        ...
        $unicast->setPredefinedKeyValue("mipush",           $this->mipush);
        $unicast->setPredefinedKeyValue("mi_activity",      $this->mi_activity);
